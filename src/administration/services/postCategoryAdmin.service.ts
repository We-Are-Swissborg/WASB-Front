 ...
 * @returns
 */
const updatePostCategory = async (id: number, token: string, data: PostCategory): Promise<boolean> => {
...
/**
 * Create post categorye
 * @param token
 * @param data
 * @returns
 */
const createPostCategory = async (token: string, data: PostCategory): Promise<boolean> => {
