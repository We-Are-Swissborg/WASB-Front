const global_en = {
    ...
    "legal": {
        ...
        "last-modification": "<0>Last updated:</0> 12 December 2025",
        "association-name": "WeAreSwissBorg Association",
        "non-profit": "<0>Non-profit association</0> according to articles 60 ff. of the Swiss Civil Code",
        "commercial-register": "Registered in the Commercial Register of the Canton of Vaud",
        "commercial-register-contact": "<0>Contact person at the Commercial Register :</0> Yannick BOILLAT",
        "head-office": "<0>Registered office :</0> WeAreSwissBorg, c/o Yannick BOILLAT, Route de Marais-rond 11a, 1847 Rennaz, Switzerland",
        "hosting": "Hosting :",
        "committee": "Committee",
        "president": "President",
        ...
        "secretary": "Secretary",
        "treasurer": "Treasurer",
        "signature": "All with joint signature by two",
        "disclaimer": "<0>Disclaimer :</0> The content of this website is for information purposes only and does not constitute financial advice. The association disclaims any liability for losses related to cryptocurrency investments.",
        "goal": "<0>Purpose :</0> Educational and community promotion of cryptocurrency through meetups and a blog, fully independent of SwissBorg SA.",
        "protection": "For the protection of your data, please refer to our",
        "policy": "Privacy and Cookies Policy",
        "director": "<0>Publication Director :</0> Julien GRANDJANNY, President"
    },
    "confidentiality": {
        "title": "Privacy and Cookie Policy",
        "last-modification": "<0>Last modification:</0> 12 December 2025",
        "welcome": "Welcome to the <0>WeAreSwissBorg</0> website, a Swiss non-profit association (art. 60 ff. Swiss Civil Code) dedicated to the educational promotion of cryptocurrency and Web3 through meetups and an informative blog.",
        "intro": "We place great importance on protecting your privacy. This policy explains how we collect, use and safeguard your personal data, in compliance with Swiss law (FDPA) and the General Data Protection Regulation (GDPR) where applicable.",
        "controller-title": "Data Controller",
        "controller-name": "Non-profit association according to art. 60 ff. Swiss Civil Code",
        "controller-register": "Commercial Register of the Canton of Vaud",
        "controller-address": "Registered office : WeAreSwissBorg, c/o Yannick BOILLAT, Route de Marais-rond 11a, 1847 Rennaz, Switzerland",
        "controller-president": "President",
        "data-collected-title": "Data Collected",
        "data-collected-forms": "Via forms (meetup registration, contact, comments)",
        "data-collected-list": "<0>Data :</0> username, email address",
        "data-collected-optional": "<0>Optional data :</0> first name, last name, country, wallet address",
        "purpose-forms": "<0>Purpose:</0> managing registrations, responding to inquiries, sending event information",
        "legal-basis-forms": "<0>Legal basis :</0> consent or steps prior to entering into a contract",
        "retention-forms": "<0>Retention period :</0> 3 years after last contact",
        "recipients-forms": "<0>Recipients :</0> committee members only",
        "analytics-title": "Audience measurement",
        "analytics-data": "<0>Data :</0> anonymised IP address, pages viewed, visit duration, device type",
        "analytics-purpose": "<0>Purpose :</0> understanding blog audience and improving content",
        "analytics-legal-basis": "<0>Legal basis :</0> explicit consent via the cookie banner",
        "analytics-retention": "<0>Retention period at Google :</0> maximum 14 months",
        "analytics-recipient": "<0>Recipient :</0> Google LLC (USA) – transfer governed by Standard Contractual Clauses",
        "no-crypto-data": "We never collect any information about your wallets, private keys, transactions or cryptocurrency holdings.",
        "rights-title": "Your Rights",
        "rights-intro": "You have the following rights :",
        "right-access": "Access, rectification and erasure of your data",
        "right-restriction": "Object to or restrict processing",
        "right-withdraw": "Withdraw consent at any time",
        "right-portability": "Data portability",
        "rights-contact": {
            "first": "Contact us at",
            "second": "or by post to the registered office. We will reply within 30 days."
        },
        "cookies-title": "Cookies and Trackers",
        "cookies-purpose-title": "Purpose",
        "cookies-duration-title": "Duration",
        "cookie-session": "Session cookies",
        "cookie-session-purpose": "Website functionality",
        "cookie-session-duration": "End of session",
        "cookie-analytics": "Anonymised audience measurement",
        "years": "2 years / 24h",
        "no-tracking": "No advertising or third-party tracking is present on this site.",
        "banner-info": "A cookie banner appears on your first visit. If you refuse, no Google Analytics cookie is set (cookieless mode activated).",
        "manage-preferences": "Manage my cookie preferences",
        "security-title": "Security and International Transfers",
        "security-details": "Hosting : OVH (France). Site secured with HTTPS. Access to data restricted to committee members. Transfer to Google (USA) governed by Standard Contractual Clauses.",
        "contact-title": "Contact and Updates",
        "contact-email": "For any question :",
        "policy-updates": "Any significant change to this policy will be announced on the website.",
        "footer-copyright": "Non-profit association – All rights reserved",
