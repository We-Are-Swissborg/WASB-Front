const global_fr = {
    "common": {
        "backtoup": "Retour au haut de la page",
        "join": "Rejoignez-nous",
    ...
    "footer": {
        ...
        "subscribe": {
            ...
            "message": "Un condensé mensuel de ce qui est nouveau et passionnant chez nous.",
    ...
    "header": {
        "en": "Anglais",
        "fr": "Français",
        "message": "Bienvenue en francais"
    },
    "home": {
        "community": "Communauté",
        "democratization": "Démocratisation",
        "discoverswissborg": "Decouvre SwissBorg",
        "education": "Education",
        "title": "Bienvenue sur WeAreSwissBorg !",
        "metrics": "Métrics",
    ...
    "ourmission": {
        "blockchain": {
            "content": `Nous croyons en la puissance de la technologie blockchain. Notre objectif est de la rendre accessible à tous ` +
        ...
        "democratization": {
            "content": "Nous croyons en un avenir financier ouvert à tous. En démocratisant l'accès aux crypto-actifs, nous voulons créer des opportunités pour chacun, partout dans le monde.",
            "title": "Démocratiser les Crypto-Actifs"
        },
        "education": {
            "content": "L'éducation est au cœur de notre démarche. Nous offrons du contenu éducatif clair et accessible, pour que chacun puisse comprendre et prendre des décisions éclairées.",
            "title": "Éduquer et Informer"
        },
        "title": "Nos objectifs"
    },
    "register": {
    ...
    "profile": {
        ...
        "my-account": {
            ...
            "not-be-contacted": "Décochez, si vous ne souhaitez plus être contacté par WeAreSwissBorg",
            "required": "Valeur obligatoire",
            "error-firstName": "Une erreur avec le prénom",
            "error-lastName": "Une erreur avec le nom",
            "error-username": "Une erreur avec le nom d'utilisateur",
            "error-email": "Une erreur avec le mail",
            "city": "Ville",
            "firstName": "Prénom",
            "lastName": "Nom",
            "email": "E-mail*",
            ...
            "placeholder": {
                ...
                "wallet-address": "Entrer l'adresse de votre portefeuille",
            },
        },
        "donations": {
            "title": "Dons",
            "message":"Scannez le QR code ci-dessous pour faire un don et aider à faire grandir notre association.\n Chaque contribution compte et fait une réelle différence.",
            "qr-code": "Le QR code pour la donation est un TEST"
        },
        "default-select": "Choisir...",
        "success-update": "Données mise à jour",
        "update": "Mise à jour",
        "form-not-changed": "Aucun changement n'a été fait",  
        "form-not-saved": "Changement non enregistré",
        "title": "Profil",
        "error-form": "Une erreur avec le formulaire",
    },
    "ternoa": {
        "logout": " Déconnexion"
    },
