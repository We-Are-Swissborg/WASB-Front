...
import '../../css/Blog.css';
import { AlternateEmailSharp, CalendarMonthSharp, ChevronLeftSharp, Visibility } from '@mui/icons-material';
import 'quill/dist/quill.snow.css';
import PostAnalytics from '@/common/PostAnalytics';
...
export default function Post() {
    ...
    useEffect(() => {
        ...
        if(consentData && consentData.preferences.analytics) {
           setIsAnalytics(true);
        } else {
    ...
    return (
        <>
            ...
            {(post && isAnalytics) && <PostAnalytics postId={post.id} lang={i18n.language} />}
        </>
    );
}
