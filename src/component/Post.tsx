        ...
        <div className="container">
            <div className="row justify-content-center">
                <div className="col-lg-8 col-md-10 col-sm-12 mx-auto pb-3">
                        ...
                        <>
                            <header className="mb-4">
                                ...
                                <div className="text-muted">
                                    <p className="mb-1"><i className="fa fa-at"></i> {t('blog.published-by')} <strong>{post.infoAuthor.username}</strong></p>
                                    <p className="mb-1"><i className="fa fa-calendar-days"></i> {t('blog.published-at')} {new Date(post.publishedAt).toLocaleDateString(`${t('blog.localCode')}`, optionDate)}</p>
                                    <div className="mb-2">
                    ...
                    <NavLink className="btn btn-secondary" to="/blog" ><i className="fa fa-chevron-left"></i> {t('blog.return-blog')}</NavLink>                    
                </div>
            </div>
        </div>
    );
