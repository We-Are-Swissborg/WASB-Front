...
function BorgyTelegramLink() {
    ...
    return <a href={t('metrics.borgy-telegram')} target="_blank"><Telegram /></a>;
};
...
Record<string, Record<'medias', Record<string, React.ReactElement>>> = {
    ...
    borgy: {
        name: 'Borgy',
        medias: {
            site: <a href='https://borgysol.com/' target="_blank"><Public /></a>,
            twitter: <a href='https://x.com/borgysol' target="_blank"><X /></a>,
